...
#' @param CellType_col column   Index of Cell type
...
#' @param ExistingClass_col     A vector give column index of existing classification of samples for example: molecular subtype of breast cancer



#' @return A data frame:
#'                      @ first 6 columns always are information of circles: "sample_id", "CircelID", "InterestCellID", "InterestCellType","XCircle", "YCircle",
#'                      @ followed by composition of celltypes
#'                      @ followed by connectivity score of celltypes
#'                      @ followed by 12 graph feaures:  "nEdges", "nVertices", "AverageDegree", "EccentricityMean", "EccentricityMin", "EccentricityMax",
#'                                                       "Transitivity", "Entropy", "Diameter", "Density", "AlgebraicConnectivity", "SpectralRadius"
...
#'      CellID_col = 1
#'      CellType_col = 63
#'      CellTypesOfInterest = "T-cytotoxic"
...
CircleObjects <- function(CircleDat, CCI, r){
    ...
    for(i in 1:length(CCIsplits)){
        ...
        CCIij$weight[CCIij$CellType1 == CCIij$CellType1] <- 1
...
Extract_Features <- function(Data,
                             ...
                             CellID_col,
                             CellType_col,
                             CellTypesOfInterest=NULL,
                             MarkersOfInterest_col=NULL,
                             Zscore=FALSE,
                             #MarkersPositivity=NULL, #
                             PositivityCutoff=0.5,
                             MetaCellType_col=NULL,
                             X_col, Y_col,
                             r,
                             minCount,
                             ExistingClass_col=NULL){

            # Assign fixed colnames
